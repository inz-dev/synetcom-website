...
Nous vous permettons de générer de la croissance grâce aux outils de la transformation numérique.
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            <h6 class="text-center mb-4 font-weight-bold">Nos coordonnées</h6>
            <p>
              <svg
              ...
              >
                ...
                /></svg
              >&nbsp; Niamey,Niger Face Pharmacie Maisons économique
            </p>
            <p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="row d-flex align-items-center">
          ...
          <div class="col-md-7 col-lg-8 text-center text-md-start">
            ...
            <div class="p-3">
              ...
              <a class="text-white" href="https://mdbootstrap.com/">Synetcom-niger</a>
            </div>
            <!-- Copyright -->
          </div>
          <!-- Grid column -->
