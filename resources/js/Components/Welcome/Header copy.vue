...
const listItems=[
    ...
    {id:2, titre_menu:'Qui sommes-nous?', link:'about_us',description_menu:'description', classActive:'', as_sousmenu:0},
     {id:3, titre_menu:'Services', link:'about_us',description_menu:'description', classActive:'',as_sousmenu:1 },
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive" >
          <ul class="navbar-nav" style="display:flex; gap:12px">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link" @click.prevent="navigateTo('about-us')">Qui sommes-nous?</a>
            </li>
