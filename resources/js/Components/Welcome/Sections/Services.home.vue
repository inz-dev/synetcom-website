  ...
  data() {
    return {
      listServices: [
        ...
        {
          id: 2,
          title: "Impression des gadgets et supports de visibilité",
          message:
            "Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, velplacerat magna mauris mollis maximus est.",
          icon: {
        ...
        {
          id: 3,
          title: "Développement d’apps web/Mobile",
          message:
            "Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, velplacerat magna mauris mollis maximus est.",
          icon: {
        ...
        },
        {
          id: 4,
          title:
            "Étude, Conseil et Formation en renforcement de capacité en Informatique",
          message:
            "Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, velplacerat magna mauris mollis maximus est.",
          icon: {
        ...
        {
          id: 6,
          title: "Hébergement et Référencement SEO",
          message:
            "Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, velplacerat magna mauris mollis maximus est.",
          icon: {
            ...
            path3:
              "M5 4.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0m-2 0a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0",
          },
        },
        {
          id: 7,
          title: "Collecte,Analyse et Interprétations des données",
          message:
            "Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, velplacerat magna mauris mollis maximus est.",
          icon: {
        ...
        {
          id: 8,
          title: "Vente de Matériels et Consommables",
          message:
            "Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, velplacerat magna mauris mollis maximus est.",
          icon: {
            class: "bi bi-receipt",
        ...
        {
          id: 9,
          title: "Analyse et Audit  de Système d’information",
          message:
            "Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, velplacerat magna mauris mollis maximus est.",
          icon: {
...
<template>
  ...
  <section class="bg-light py-5 py-xl-8" id="services">
      ...
      <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7">
          <h3 class="fs-6 mb-2 text-center text-uppercase">
            Déterminez le service dont vous avez besoin
          </h3>

          <hr class="w-25 mx-auto mb-4 mb-xl-9 border-primary-subtle" />
        </div>
      </div>
    </div>
            ...
            <div class="card-body text-center p-4 p-xxl-5">
              ...
              >
                ...
                <!-- <BootstrapIcon
                  ...
                  path1="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"
                /> -->
              </a>
            </div>
          </div>
    ...
    <div class="card-footer text-center">
      <PrimaryButton label="Découvrir tous nos services"></PrimaryButton>
    </div>
  </section>
</template>
<style scoped>
